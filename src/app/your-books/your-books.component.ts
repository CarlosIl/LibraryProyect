...
export class YourBooksComponent{
  ...
  // libros: Array<string|string|string|string>;

  // constructor(tituloLibro: string, rutaPortada: string, resumen: string, enlaceAmazon: string, libros: Array<string>){
  //   super(tituloLibro, rutaPortada, resumen, enlaceAmazon);
  //   this.libros=libros;
  // }
